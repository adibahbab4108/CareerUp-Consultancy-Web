    ...
    return (
        ...
        <footer className="footer p-10 rounded-t-lg bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 shadow-lg text-gray-300">
          ...
          <nav className="space-y-2">
            ...
            <a className="block text-gray-300 hover:text-pink-500 transition">Branding</a>
            <a className="block text-gray-300 hover:text-teal-400 transition">Design</a>
            <a className="block text-gray-300 hover:text-purple-500 transition">Marketing</a>
            <a className="block text-gray-300 hover:text-blue-400 transition">Advertisement</a>
          </nav>
      
          {/* Company Section */}
          <nav className="space-y-2">
            <h6 className="text-lg font-bold text-white mb-2">Company</h6>
            <a className="block text-gray-300 hover:text-teal-400 transition">About us</a>
            <a className="block text-gray-300 hover:text-pink-500 transition">Contact</a>
            <a className="block text-gray-300 hover:text-purple-500 transition">Jobs</a>
            <a className="block text-gray-300 hover:text-blue-400 transition">Press kit</a>
          </nav>
